...
void lfrfid_scene_start_on_enter(void* context) {
    ...
    submenu_add_item(submenu, "Ler", SubmenuIndexRead, lfrfid_scene_start_submenu_callback, app);
    submenu_add_item(
        submenu, "Salvos", SubmenuIndexSaved, lfrfid_scene_start_submenu_callback, app);
    submenu_add_item(
        submenu, "Adicionar Manualmente", SubmenuIndexAddManually, lfrfid_scene_start_submenu_callback, app);
    submenu_add_item(
        submenu,
        "Mais Acoes",
        SubmenuIndexExtraActions,
