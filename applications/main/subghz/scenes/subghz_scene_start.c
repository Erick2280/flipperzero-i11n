...
void subghz_scene_start_on_enter(void* context) {
    ...
    submenu_add_item(
        subghz->submenu, "Ler", SubmenuIndexRead, subghz_scene_start_submenu_callback, subghz);
    submenu_add_item(
        subghz->submenu,
        "Ler Bruto",
        SubmenuIndexReadRAW,
        ...
        subghz);
    submenu_add_item(
        subghz->submenu, "Salvos", SubmenuIndexSaved, subghz_scene_start_submenu_callback, subghz);
    submenu_add_item(
        subghz->submenu,
    ...
    submenu_add_item(
        subghz->submenu,
        "Informacoes de Regiao",
        SubmenuIndexShowRegionInfo,
        subghz_scene_start_submenu_callback,
        subghz);
    submenu_add_item(
        subghz->submenu,
        "Configuracoes de Radio",
        SubmenuIndexRadioSetting,
        subghz_scene_start_submenu_callback,
        subghz);
