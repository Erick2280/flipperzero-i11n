...
void subghz_scene_need_saving_on_enter(void* context) {
    ...
    widget_add_string_multiline_element(
        subghz->widget, 64, 13, AlignCenter, AlignCenter, FontPrimary, "Sair para o Menu Sub-GHz?");
    widget_add_string_multiline_element(
        subghz->widget,
        64,
        32,
    ...
    widget_add_button_element(
        subghz->widget, GuiButtonTypeRight, "Ficar", subghz_scene_need_saving_callback, subghz);
    widget_add_button_element(
        subghz->widget, GuiButtonTypeLeft, "Sair", subghz_scene_need_saving_callback, subghz);
