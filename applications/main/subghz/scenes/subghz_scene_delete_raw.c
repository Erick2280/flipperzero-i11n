...
void subghz_scene_delete_raw_on_enter(void* context) {
    ...
    snprintf(delete_str, sizeof(delete_str), "\e#Apagar %s?\e#", furi_string_get_cstr(file_name));
    ...
    widget_add_string_element(
        subghz->widget, 38, 25, AlignLeft, AlignTop, FontSecondary, "Sinal Bruto");
    ...
    widget_add_button_element(
        subghz->widget, GuiButtonTypeRight, "Apagar", subghz_scene_delete_raw_callback, subghz);
    widget_add_button_element(
        subghz->widget, GuiButtonTypeLeft, "Voltar", subghz_scene_delete_raw_callback, subghz);
